...
public enum STMnemonic {
    
    static public func mnemonicString(from bytes: [UInt8], language: MnemonicLanguageType = .english) throws -> String {
    ...
    static public func mnemonicString(from hexString: String, language: MnemonicLanguageType = .english) throws -> String {
    ...
    static public func deterministicSeedString(from mnemonic: String, iterations: Int = 2_048, passphrase: String = "", language: MnemonicLanguageType = .english) throws -> String {
    ...
    /// - Throws: `MnemonicError.checksumError` if checksum fails, `MnemonicError.invalidInput` if received input is invalid
    static public func deterministicSeedBytes(from mnemonic: String,  iterations: Int = 2_048, passphrase: String = "", language: MnemonicLanguageType = .english) throws -> [UInt8] {
    ...
    ///  - `MnemonicError.InvalidHexString`  when an invalid string is given
    ///  - `MnemonicError.invalidBitString` when the resulting bitstring generates an invalid word index
    static public func generateMnemonic(strength: Int, language: MnemonicLanguageType = .english) throws
        -> String {
    ...
    static public func validate(mnemonic: String) throws {
    ...
    static public func bytes(mnemonic: String) throws -> [UInt8] {
        let mnemonicComponents = mnemonic.components(separatedBy: " ")
        guard !mnemonicComponents.isEmpty else {
            throw MnemonicError.wrongWordCount
        }
    ...
    static public func determineLanguage(from mnemonicWords: [String]) throws -> MnemonicLanguageType {
