...
public protocol STImagePickerHelperDelegate: UIViewController {
...
public class STPHPhotoHelper: NSObject {
    ...
    public func deleteAssetsAfterManualImport(assets: [PHAsset]) {
...
public extension STPHPhotoHelper {
