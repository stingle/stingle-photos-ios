...
public protocol IDownloaderSource: STDownloadRequest {
...
extension STDownloaderManager {
    ...
    public class Downloader<T: IDiskCacheObject> {
        ...
        public func cancel(operation identifier: String, forceCancel: Bool = false) {
