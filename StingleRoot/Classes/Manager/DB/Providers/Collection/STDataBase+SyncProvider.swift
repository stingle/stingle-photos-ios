...
extension STDataBase {
    ...
    public class SyncProvider<Model: ICDSynchConvertable, DeleteFile: ILibraryDeleteFile>: CollectionProvider<Model> where Model.ManagedModel: ISynchManagedObject {
        ...
        public override func getInsertObjects(with files: [Model]) throws -> (json: [[String : Any]], models: Set<Model>, objIds: [String : Model], lastDate: Date) {
...
public extension STDataBase.SyncProvider where Model.ManagedModel: STCDFile  {
