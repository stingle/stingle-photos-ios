...
public class STDBInfo: ICDConvertable {
    ...
    public var spaceUsed: String?
    public var spaceQuota: String?
    ...
    required convenience public init(model: STCDDBInfo) throws {
    ...
    public func update(with used: STDBUsed) {
        self.spaceUsed = "\(used.spaceUsed)"
        self.spaceQuota = used.spaceQuota
    }
    
    public func update(with spaceQuota: String, spaceUsed: String) {
        self.spaceUsed = spaceUsed
        self.spaceQuota = spaceQuota
    }
    
    public func update(model: STCDDBInfo) {
