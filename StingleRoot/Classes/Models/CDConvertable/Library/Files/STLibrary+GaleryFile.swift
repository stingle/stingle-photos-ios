...
extension STLibrary {
    ...
    open class GaleryFile: File<STCDGaleryFile> {
        ...
        required public init(model: STCDGaleryFile) throws {
        ...
        override public init(fileName: String, version: String, headers: String, dateCreated: Date, dateModified: Date, isRemote: Bool, isSynched: Bool, managedObjectID: NSManagedObjectID?) {
        ...
        override public func copy(fileName: String? = nil, version: String? = nil, headers: String? = nil, dateCreated: Date? = nil, dateModified: Date? = nil, isRemote: Bool? = nil, isSynched: Bool? = nil) -> Self {
