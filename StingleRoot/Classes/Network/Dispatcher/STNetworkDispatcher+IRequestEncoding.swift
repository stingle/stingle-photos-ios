...
public protocol IRequestEncoding: ParameterEncoding {
...
public extension STNetworkDispatcher {
...
extension STNetworkDispatcher.Encoding: IRequestEncoding {
    ...
    public func encodeParameters(_ urlRequest: URLRequest, with parameters: [String : Any]?) throws -> URLRequest {
        switch self {
        case .queryString:
