...
public class STFileWorker: STWorker {
    ...
    public func deleteFiles(files: [STLibrary.TrashFile], success: Success<STEmptyResponse>?, failure: Failure?) {
        guard !files.isEmpty else {
            success?(STEmptyResponse())
            return
        }
    ...
    public func moveToGalery(files: [STLibrary.TrashFile], success: Success<STEmptyResponse>?, failure: Failure?) {
        guard !files.isEmpty else {
            success?(STEmptyResponse())
            return
        }
