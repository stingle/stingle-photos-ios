...
class STMenuStoryboardSegue: UIStoryboardSegue {
    ...
    override func perform() {
        let menuViewController = self.source as! STMenuVC
        let masterViewController = self.destination as! STMenuMasterVC
        menuViewController.setMasterViewController(masterViewController: masterViewController, isAnimated: true)
    }
