...
extension STDownloaderManager {
    ...
    class FileDownloader: Downloader<STDownloaderManager.DiskCacheObject> {
        ...
        @discardableResult
        internal override func download(source: IDownloaderSource, success: STDownloaderManager.RetryerSuccess<STDownloaderManager.DiskCacheObject>?, progress: STDownloaderManager.RetryerProgress?, failure: STDownloaderManager.RetryerFailure?) -> String {
