...
extension CachingPlayerItem {
    ...
    class ResourceLoaderDelegate: NSObject, AVAssetResourceLoaderDelegate, URLSessionDelegate, URLSessionDataDelegate, URLSessionTaskDelegate {
        ...
        func urlSession(_ session: URLSession, dataTask: URLSessionDataTask, didReceive data: Data) {
            ...
            print("rrrrrr", mediaData?.count ?? 0, data.count)
        ...
        func fillInContentInformationRequest(_ contentInformationRequest: AVAssetResourceLoadingContentInformationRequest?) {
            ...
            print("expectedContentLength", responseUnwrapped.expectedContentLength)
            
            contentInformationRequest?.isByteRangeAccessSupported = true
            
//            print("contentInformationRequest contentType", contentInformationRequest?.contentType ?? "")
//            print("contentInformationRequest contentLength", contentInformationRequest?.contentLength ?? "")
//            print("contentInformationRequest isByteRangeAccessSupported", contentInformationRequest?.isByteRangeAccessSupported ?? "")            
        ...
        func haveEnoughDataToFulfillRequest(_ dataRequest: AVAssetResourceLoadingDataRequest) -> Bool {
            ...
            print("contentInformationRequest requestedOffset", requestedOffset)
//            print("contentInformationRequest requestedLength", requestedLength)
//            print("contentInformationRequest currentOffset", currentOffset)
            ...
            let result = songDataUnwrapped.count >= requestedLength + requestedOffset
            
            print("contentInformationRequest respond", dataToRespond.count, result)
